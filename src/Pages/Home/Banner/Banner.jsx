    ...
    return (
        <div className="carousel w-full h-[500px] rounded-md">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute h-full flex items-center gap-3 left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)]">
                    <div className='text-white space-y-6 w-1/2 pl-4'>
